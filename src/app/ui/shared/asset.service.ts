...
export class AssetService {
  ...
  createAndStoreAsset(postData: IAsset, routeUrl: string) {
    // Send Http request 
    this.http.post(
  ...
  fetchGroupsFromDb(): Observable<any>{
    const groupsDataUrl = this.http
      .get<{[key: string]: IGroups}>( // key is the string generated by firebase 
      'https://asset-grouping-app-exercise.firebaseio.com/Groups'+ ".json",);
  ...
  fetchAssetsFromDb(): Observable<any> {
